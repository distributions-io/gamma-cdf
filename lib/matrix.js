...
*	Evaluates the cumulative distribution function (CDF) for a Gamma distribution with shape parameter `alpha` and rate parameter `beta` for each matrix element.
*
